      ...
      services: [
        {
          ...
          shortDescription: 'Strategic content that builds audience',
          description: 'We develop social media strategies that build audience and drive engagement. From content pillars to posting schedules, we create roadmaps for social success.',
          image: 'https://illustrations.popsy.co/amber/idea.svg',
          features: [
            'Platform Strategy',
            'Content Pillars',
            'Content Calendar',
          ...
          techStack: [
            { category: 'Planning', technologies: ['Notion', 'Airtable', 'Google Sheets'] },
            { category: 'Scheduling', technologies: ['Buffer', 'Later', 'Hootsuite'] },
            { category: 'Analytics', technologies: ['Native Insights', 'Sprout Social'] },
            { category: 'Research', technologies: ['SparkToro', 'BuzzSumo', 'Trends'] }
          ],
          workflow: [
            { step: 1, title: 'Audit', description: 'Analyze current social presence.' },
            { step: 2, title: 'Research', description: 'Audience and competitor analysis.' },
            { step: 3, title: 'Strategy', description: 'Develop content strategy.' },
            { step: 4, title: 'Calendar', description: 'Create content calendar.' },
            { step: 5, title: 'Execution', description: 'Support implementation and track.' }
          ],
          whyChooseUs: [
            { title: 'Data-Driven', description: 'Strategy backed by analytics.', icon: '📊' },
            { title: 'Platform Native', description: 'Know each platform deeply.', icon: '📱' },
            { title: 'Actionable', description: 'Clear execution plans.', icon: '📋' },
            { title: 'Measurable', description: 'Track progress and ROI.', icon: '📈' }
          ],
          faqs: [
            { question: 'Which platforms should we focus on?', answer: 'We recommend based on your audience and resources.' },
            { question: 'How often should we post?', answer: 'Depends on platform and resources; quality over quantity.' },
            { question: 'Do you help with content creation?', answer: 'Strategy focus, but we can connect you with creators.' },
            { question: 'How do we measure success?', answer: 'We define KPIs and tracking from the start.' }
          ]
        },
        {
          slug: 'creative-direction-campaign-planning',
          name: 'Creative Direction & Campaign Planning',
          shortDescription: 'Big ideas that make impact',
          description: 'We provide creative direction for campaigns and brand initiatives. From concept development to execution oversight, we help bring big ideas to life.',
          image: 'https://illustrations.popsy.co/amber/creative-flow.svg',
          features: [
            'Campaign Concepts',
            'Creative Direction',
            'Brand Campaigns',
          ...
          techStack: [
            { category: 'Planning', technologies: ['Notion', 'Miro', 'Monday.com'] },
            { category: 'Creative', technologies: ['Figma', 'Adobe CC', 'Canva'] },
            { category: 'Presentation', technologies: ['Keynote', 'PowerPoint'] },
            { category: 'Collaboration', technologies: ['Slack', 'Asana', 'Frame.io'] }
          ],
          workflow: [
            { step: 1, title: 'Brief', description: 'Define campaign objectives and constraints.' },
            { step: 2, title: 'Concept', description: 'Develop creative concepts.' },
            { step: 3, title: 'Direction', description: 'Create creative direction and guidelines.' },
            { step: 4, title: 'Production', description: 'Oversee creative production.' },
            { step: 5, title: 'Launch', description: 'Support campaign launch and optimization.' }
          ],
          whyChooseUs: [
            { title: 'Big Picture', description: 'See the full campaign vision.', icon: '🔭' },
            { title: 'Execution Focus', description: 'Concepts that can be produced.', icon: '✅' },
            { title: 'Brand Alignment', description: 'Creative that builds your brand.', icon: '🎯' },
            { title: 'Team Leadership', description: 'Coordinate creative teams effectively.', icon: '👥' }
          ],
          faqs: [
            { question: 'Do you produce the creative?', answer: 'We can lead production or work with your creative team.' },
            { question: 'How big of campaigns do you handle?', answer: 'From focused digital campaigns to major brand initiatives.' },
            { question: 'What is creative direction?', answer: 'Guiding the visual and conceptual approach to achieve campaign goals.' },
            { question: 'Can you work with our agencies?', answer: 'Yes, we often coordinate with external agencies and freelancers.' }
          ]
        },
        {
          slug: 'content-repurposing-systems',
          name: 'Content Repurposing Systems',
          shortDescription: 'Get more from every piece of content',
          description: 'We build systems to repurpose content across channels and formats. Turn one piece of content into many, maximizing your content ROI.',
          image: 'https://illustrations.popsy.co/amber/recycle.svg',
          features: [
            'Content Atomization',
          ...
          techStack: [
            { category: 'Content', technologies: ['Notion', 'Airtable', 'Descript'] },
            { category: 'Design', technologies: ['Canva', 'Figma', 'Adobe CC'] },
            { category: 'Video', technologies: ['Descript', 'Premiere', 'CapCut'] },
            { category: 'Automation', technologies: ['Zapier', 'Make', 'Custom'] }
          ],
          workflow: [
            { step: 1, title: 'Audit', description: 'Review your content assets.' },
            { step: 2, title: 'Strategy', description: 'Plan repurposing approach.' },
            { step: 3, title: 'Systems', description: 'Build repurposing workflows.' },
            { step: 4, title: 'Templates', description: 'Create reusable templates.' },
            { step: 5, title: 'Training', description: 'Train your team on systems.' }
          ],
          whyChooseUs: [
            { title: 'Efficiency', description: 'Get 10x content from same effort.', icon: '⚡' },
            { title: 'Systems Thinking', description: 'Sustainable, repeatable processes.', icon: '🔄' },
            { title: 'Platform Smart', description: 'Know what works where.', icon: '📱' },
            { title: 'Quality Focus', description: 'Repurposed content that feels native.', icon: '✨' }
          ],
          faqs: [
            { question: 'What content can be repurposed?', answer: 'Blog posts, podcasts, videos, webinars, reports - almost anything.' },
            { question: 'Does repurposed content feel repetitive?', answer: 'Done right, each piece feels native to its platform.' },
            { question: 'Can you do the repurposing for us?', answer: 'Yes, or we can train your team with systems.' },
            { question: 'How much more content can we get?', answer: 'Typically 5-10x more pieces from each core content.' }
          ]
        },
        {
          slug: 'performance-creative-optimization',
          name: 'Performance-Driven Creative Optimization',
          shortDescription: 'Creative that converts based on data',
          description: 'We use data to optimize creative performance. From A/B testing to creative analysis, we help you create content that delivers measurable results.',
          image: 'https://illustrations.popsy.co/amber/test-tube.svg',
          features: [
            'Creative Testing',
            'A/B Analysis',
          ...
          techStack: [
            { category: 'Testing', technologies: ['Meta Ads', 'Google Ads', 'Landing Pages'] },
            { category: 'Analytics', technologies: ['Google Analytics', 'Mixpanel', 'Hotjar'] },
            { category: 'Optimization', technologies: ['VWO', 'Optimizely', 'Custom'] },
            { category: 'Design', technologies: ['Figma', 'Canva', 'Adobe CC'] }
          ],
          workflow: [
            { step: 1, title: 'Baseline', description: 'Analyze current creative performance.' },
            { step: 2, title: 'Hypothesis', description: 'Develop test hypotheses.' },
            { step: 3, title: 'Create', description: 'Design test variations.' },
            { step: 4, title: 'Test', description: 'Run A/B tests.' },
            { step: 5, title: 'Learn', description: 'Analyze and apply insights.' }
          ],
          whyChooseUs: [
            { title: 'Data-Driven', description: 'Decisions backed by real data.', icon: '📊' },
            { title: 'Iterative', description: 'Continuous improvement cycles.', icon: '🔄' },
            { title: 'Results Focus', description: 'Optimize for business outcomes.', icon: '📈' },
            { title: 'Creative + Analytics', description: 'Blend of creativity and analysis.', icon: '🎯' }
          ],
          faqs: [
            { question: 'What do you test?', answer: 'Ad creative, landing pages, emails, CTAs - anything visual.' },
            { question: 'How long do tests run?', answer: 'Until we reach statistical significance, typically 1-4 weeks.' },
            { question: 'What tools do you use?', answer: 'Native ad platform testing plus dedicated tools like VWO.' },
            { question: 'How do you share results?', answer: 'Regular reports with insights and recommendations.' }
          ]
        }
      ]
    }
