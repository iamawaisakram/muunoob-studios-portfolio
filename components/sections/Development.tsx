...
import { ArrowRight, Code2, ShoppingCart, Server, Shield } from 'lucide-react'
import SectionWrapper, { SectionHeader } from '@/components/ui/SectionWrapper'
import { DEVELOPMENT_SERVICES } from '@/lib/constants'

const categoryIcons: Record<string, typeof Code2> = {
  'Web, App & System Development': Code2,
  'E-Commerce & Platforms': ShoppingCart,
  'Backend & Infrastructure': Server,
  'Performance & Security': Shield,
}

export default function Development() {
  const categories = Object.entries(DEVELOPMENT_SERVICES)

  return (
    <SectionWrapper id="development" className="bg-white">
      {/* Decorative elements */}
      ...
      <SectionHeader
        title="Development"
        subtitle="End-to-end development solutions from concept to deployment, built with cutting-edge technologies"
      />
